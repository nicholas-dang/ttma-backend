...
function dedYear(req, res) {
    if (req.method === "POST" && req.url === "/dedYear") {
        let data = "";
        ...
        req.on("end", () => {
            try {
                ...
                sql = "SELECT DISTINCT YearID from TaxDeductionsExpenses WHERE UserID = (" + UserID + ") ORDER BY YearID;";
