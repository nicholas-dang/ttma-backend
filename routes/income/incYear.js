...
function incYear(req, res) {
    if (req.method === "POST" && req.url === "/incYear") {
        let data = "";
        ...
        req.on("end", () => {
            try {
                ...
                sql = "SELECT DISTINCT YearID from AdditionalIncome WHERE UserID = (" + UserID + ") ORDER BY YearID;";
