...
function donYear(req, res) {
    if (req.method === "POST" && req.url === "/donYear") {
        let data = "";
        ...
        req.on("end", () => {
            try {
                ...
                sql = "SELECT DISTINCT YearID from Donations WHERE UserID = (" + UserID + ") ORDER BY YearID;";
